...
2. The app will open in setup mode
3. Enter your Gmail email and 16-character app password
4. Enter the recipient email, subject, and message
...
1. Double-click `EmailAutomationBot.exe`
2. Fill in the setup fields if they are blank
3. Click "Save Configuration"
4. Click "Send Single Email" to test
5. Use the GUI controls to send batches or run continuously

### Troubleshooting

**"Configuration error" message:**
- Open the app and click Save Configuration again
- Make sure your Gmail email and app password are entered correctly
